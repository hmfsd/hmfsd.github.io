...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function renderEventCard(event) {
    ...
    const ticketIcon = `<svg width="22" height="22" viewBox="0 0 24 24" fill="#e53935" style="margin-right:4px;flex-shrink:0;"><path d="M22 10V6a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v4a2 2 0 0 1 0 4v4a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-4a2 2 0 0 1 0-4zM13 17.5h-2v-2h2v2zm0-4.5h-2v-2h2v2zm0-4.5h-2v-2h2v2z"/></svg>`;
    if (event.ticketWebsite && event.featured) {
      links.push(`<a href="${event.ticketWebsite}" class="btn btn--ticket-primary" target="_blank" rel="noopener noreferrer"><span class="ticket-top">${ticketIcon}Ticket Website</span><span class="ticket-subtitle">(Buy Tickets)</span></a>`);
    } else if (event.ticketWebsite) {
      links.push(`<a href="${event.ticketWebsite}" class="btn btn--outline" target="_blank" rel="noopener noreferrer">${ticketIcon}Ticket Website</a>`);
    }
    if (event.ra) {
